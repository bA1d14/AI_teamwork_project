...
from kivy_garden.mapview.view import clamp ,MIN_LONGITUDE , MIN_LATITUDE, MAX_LATITUDE, MAX_LONGITUDE
...
class LineMapLayer(MapLayer):
    ...
    def coordinates(self, coordinates):
        ...
        mapview = self.parent
        mapview.center_on(self._coordinates[0][0], self._coordinates[0][1])
        mapview.zoom = 8
